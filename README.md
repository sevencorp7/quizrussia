...
<body>
    ...
    <script>
        const quizData = [
    {
        question: "В регионе проживают народ А (56 %), народ Б (22 %) и ещё 3 народа с равной долей. Если общая численность — 2 млн человек, сколько представителей каждого из трёх малых народов?",
        options: ["120 тыс.", "146 667", "160 тыс.", "180 тыс."],
        correct: 1
    },
    {
        question: "На фестивале народного творчества участвуют 4 коллектива: народ А, народ Б, народ В и народ Г. Народ А составляет 40 % участников, народ Б — ⅔ от числа народа А, народ В — на 20 человек меньше народа Б. Если всего 300 человек, сколько народа Г?",
        options: ["35", "40", "45", "50"],
        correct: 1
    },
    {
        question: "Площадь многонационального округа — 850 км². Леса занимают 36 %, пашни — 44 %. Остальная территория — поселения и дороги (в соотношении 3 : 1). Какова площадь дорог?",
        options: ["42,5 км²", "48,5 км²", "51 км²", "68 км²"],
        correct: 0
    },
    {
        question: "В строительстве объекта работали 150 рабочих: народ А, народ Б, народ В. Народа А на 30 больше, чем народа Б, а народа В — в 1,5 раза меньше, чем народа Б. Сколько народа В?",
        options: ["20", "24", "30", "36"],
        correct: 2
    },
    {
    ...
    {
        question: "Высота башни — 14,4 м. На чертеже в масштабе 1 : 75 её высота 19,0 см. Соответствует ли чертёж масштабу?",
        options: ["да, точно", "нет, занижена на 0,2 см", "нет, завышена на 0,3 см", "нет, занижена на 0,4 см"],
        correct: 1
    },
    {
        question: "В команде строителей 96 человек. Народ А составляет ½ команды, народ Б — ⅔ народа А, остальные — представители других народов. Сколько «других»?",
        options: ["16", "20", "24", "28"],
        correct: 0
    },
    {
        question: "Смета на строительство: материалы — 2,1 млн руб., работа — 1,35 млн руб. Накладные расходы — 22 %. Итоговая стоимость с НДС (20 %)?",
        options: ["4 536 тыс. руб.", "4 622,4 тыс. руб.", "5 050 тыс. руб.", "5 800 тыс. руб."],
        correct: 2
    },
    {
        question: "В районе 300 сёл. Газифицировано 20 % из них. Из оставшихся ⅖ имеют доступ к газу через соседей. Сколько сёл полностью без газа?",
        options: ["126", "132", "144", "156"],
        correct: 2
    },
    {
        question: "Длина дороги — 240 км. За первый месяц построили 35%, за второй — 30% длины. Сколько км осталось?",
    ...
    {
        question: "В конкурсе участвовали 200 человек: народ А, народ Б, народ В, народ Г. Народ А составляет 45,5% участников, народ Б — на 25 человек меньше народа А, народ В — ½ народа Б. Сколько народа Г?",
        options: ["10", "15", "20", "25"],
        correct: 0
    },
    {
    ...
    {
        question: "Высота здания — 79,2 м. Первые 6 этажей — по 3,6 м, остальные — по 3,2 м. Сколько всего этажей?",
        options: ["22", "23", "24", "25"],
        correct: 2
    },
    {
        question: "В регионе 500 тыс. жителей. За 7 лет 14% переехали, но прибыло 10% новых жителей (от оставшегося населения). Какова численность сейчас?",
        options: ["473 тыс.", "482 тыс.", "490 тыс.", "504 тыс."],
        correct: 0
    },
    {
    ...
    {
        question: "В многонациональном посёлке 450 жителей: народ А, народ Б, народ В и народ Г. Народ А составляет 40%, народ Б — ⅔ от числа народа А, народ В — на 15 человек меньше народа Б. Сколько народа Г?",
        options: ["45", "60", "75", "90"],
        correct: 0
    },
    {
        question: "На межрегиональной стройке работают 240 человек. Народ А составляет 50% , народ Б — ⅖ от числа народа А, остальные — представители других народов. Сколько «других»?",
        options: ["36", "48", "60", "72"],
        correct: 3
    },
    {
    ...
    {
        question: "Высота минарета мечети — 54 м, колокольни храма — 48 м. На чертеже в масштабе 1 : 600 разница их высот составляет 1 см. Соответствует ли чертёж масштабу?",
        options: ["да, точно", "нет, занижена на 0,1 см", "нет, завышена на 0,2 см", "нет, занижена на 0,3 см"],
        correct: 0
    },
    {
        question: "В регионе 420 сёл. Газифицировано 20% из них. Из оставшихся ⅜ имеют доступ к газу через соседей. Сколько сёл полностью без газа?",
        options: ["147", "168", "189", "210"],
        correct: 3
    },
    {
        question: "Длина автодороги — 360 км. За первый месяц построили 40%, за второй — столько же, сколько за первый. Сколько км осталось?",
        options: ["72 км", "86,4 км", "96 км", "108 км"],
        correct: 0
    },
    {
        question: "В школе 1 500 учеников. Дети мигрантов составляют 32%. Из них ⅝ — из стран СНГ, остальные — из Закавказья. Сколько учеников из Закавказья?",
        options: ["180", "216", "240", "288"],
        correct: 0
    },
    {
        question: "Плотность кирпича — 1 800 кг/м³. Для кладки стены нужно 4,9 м³ материала. Какова масса материала?",
        options: ["7 560 кг", "8 127 кг", "8 460 кг", "8 820 кг"],
        correct: 3
    },
    {
        question: "В конкурсе участвовали 250 человек: народ А, народ Б, народ В, народ Г. Народ А составляет 44%, народ Б — на 30 человек меньше народа А, народ В — ½ народа Б. Сколько народа Г?",
        options: ["10", "15", "20", "25"],
        correct: 2
    },
    {
